...
const AdminDashboard = () => {
  ...
  const exportScholarships = async () => {
    setExportLoading(true);
    try {
      const { data, error } = await apiService.exportActiveScholarships();
      if (error) {
      ...
      a.href = url;
      a.download = `scholarships_export_${new Date().toISOString().slice(0, 10)}.csv`;
      ...
      setSnackbar({
        open: true,
        message: error.message || "Failed to export scholarships",
        severity: "error",
      });
    } finally {
      setExportLoading(false);
    ...
    <>
      <div className="min-h-screen bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Super Admin Panel has been moved to User Management */}
          {/* Quick Actions */}
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <div className="font-medium">Export Scholarships</div>
                </button>
              </div>
            </div>
          </div>
